            ...
            <View style={styles.container}>
                ...
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    <View style={styles.FontContainer}>
                        <CustomText bold style={{ fontSize: 20, color: '#4F4F4F' }} allowFontScaling={false}>
                            한글, 영어, 숫자 조합의 1-15자{'\n'}길이의 닉네임으로 설정해 주세요.
                        </CustomText>
                    </View>
                    ...
                    <View style={{ width: '80%' }}>
                        <CustomText style={{ fontSize: 13, color: '#757575' }}>현재 닉네임 : {Nname}</CustomText>
                    </View>
                </View>
                ...
                <View style={styles.BtnContainer}>
                    <TouchableOpacity style={styles.BtnStyle} onPress={CheckNname}>
                        <CustomText
                            bold
                            style={{ fontSize: 20, color: 'white', lineHeight: 30 }}
