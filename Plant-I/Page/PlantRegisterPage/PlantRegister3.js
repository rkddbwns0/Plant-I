                ...
                <View style={{ flex: 1, alignItems: 'center' }}>
                    ...
                    <View style={styles.mainView}>
                        <View style={styles.fontView}>
                            <CustomText bold style={styles.boldFontStyles} allowFontScaling={false}>
                                1. 식물의 별명을 입력해 주세요.
                            </CustomText>
                        </View>
                        ...
                        <View style={{ width: '100%', alignItems: 'center' }}>
                            <TouchableOpacity style={styles.inputStyles} onPress={() => setLastWateredVisibled(true)}>
                                <CustomText style={{ lineHeight: 20 }} allowFontScaling={false}>
                                    {last_Watered}
                                </CustomText>
                            </TouchableOpacity>
                        </View>
