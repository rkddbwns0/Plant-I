...
const LoginPage = () => {
    ...
    const Login = async () => {
        try {
            const response = await axios.post(`${SERVER_ADDRESS}/userdb/login`, { id, pw }, { withCredentials: true });
        ...
        <KeyboardAvoidingView style={styles.container}>
            ...
            <View style={{ flex: 1, justifyContent: 'center' }}>
                <View style={styles.topTextView}>
                    <Text style={styles.topText}>안녕하세요!{'\n'}로그인 후 서비스를 이용해 보세요.</Text>
                </View>
            ...
            <View style={styles.bottomView}>
                ...
                <View style={styles.Form}>
                    ...
                    <Text style={{ fontSize: 11, lineHeight: 12 }}> | </Text>
