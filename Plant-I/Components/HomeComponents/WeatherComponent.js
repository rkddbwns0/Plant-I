...
const WeatherComponent = ({ weatherData, handleLocationChange, weatherImg }) => {
    ...
    return (
        <View style={styles.WeatherContainer}>
            <View style={styles.WeatherInfoContainer}>
                <Text style={{ ...styles.WeatherFontStyles, marginLeft: '4%', flexShrink: 1, flexGrow: 1 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <View style={styles.WeatherDataStyles}>
                        <View style={{ flexDirection: 'row' }}>
                            <Text style={styles.WeatherFontStyles}>최저 {weatherData?.temp_min}°</Text>
                            <Text style={styles.WeatherFontStyles}>최고 {weatherData?.temp_max}°</Text>
                        </View>
                        <Text style={styles.WeatherFontStyles}>습도 {weatherData?.humidity}%</Text>
                    </View>
                </View>
            </View>
