...
import { selectImage, takePhoto } from '../imageComponents/chatbotImageUpload';

const ChatbotImageSelectModal = ({ visible, onCloseRequest, onCancel, onImageSelected, Routes }) => {
...
export default ChatbotImageSelectModal;
