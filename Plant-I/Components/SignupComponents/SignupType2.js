        ...
        <View style={styles.container}>
            ...
            <View style={styles.inputContainer}>
                ...
                <View style={styles.checkTextView}>
                    <Text style={[styles.checkText, check1 ? styles.successText : styles.errorText]}>
                        {checkMessage1}
                    </Text>
                </View>
                ...
                <View style={{ alignItems: 'center' }}>
                    <View style={{ ...styles.inputView, flexDirection: 'row' }}>
                        ...
                        <TouchableOpacity style={styles.checkBtnStyle} onPress={checkUser}>
                            <Text style={styles.checkBtnText}>{checkBtnText}</Text>
                        </TouchableOpacity>
                    </View>
                </View>
                <View style={styles.checkTextView}>
                    <Text style={[styles.checkText, check2 ? styles.successText : styles.errorText]}>
                        {checkMessage2}
                    </Text>
                </View>
            </View>
