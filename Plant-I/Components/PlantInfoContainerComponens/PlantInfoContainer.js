        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.PlantNameContainer}>
                <TouchableOpacity style={styles.PlantNameStyle} onPress={PnameOnPress} disabled={PnameDisabled}>
                    <CustomText style={{ fontSize: 18, lineHeight: 25 }} allowFontScaling={false}>
                        {Pname}
                    </CustomText>
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.UserPlantInfoContainer}>
                <View style={styles.InfoStyle}>
                    <CustomText style={styles.infoText} allowFontScaling={false}>
                        키우기 시작한 날
                    </CustomText>
                    <TouchableOpacity
                        ...
                        disabled={disabled}
                    >
                        <CustomText style={styles.DataStyles} allowFontScaling={false}>
                            {Plant_Date}
                        </CustomText>
                    </TouchableOpacity>
                </View>
